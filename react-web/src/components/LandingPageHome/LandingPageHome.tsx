              ...
              <div className="card card-background align-items-start mb-4 mb-lg-0 undefined">
                <a href="https://demos.creative-tim.com/astro-ecommerce/landing/#">
                  <div
                    className="full-background"
                    style={{
                      backgroundImage: `url(${require("./images/category2.jpg")})`,
                      backgroundSize: "cover",
                    }}
                  ></div>
                </a>
                <div className="card-body text-center w-100 pt-8">
                  ...
                  <div className="d-block mt-10">
                    <a href="https://demos.creative-tim.com/astro-ecommerce/landing/#">
                      ...
                      <h4 className="text-white font-weight-bolder">Suits</h4>
                    </a>
                    <a
                      href="https://demos.creative-tim.com/astro-ecommerce/landing/#"
                      className="text-white text-sm font-weight-semibold mb-0"
              ...
              <div className="card card-background align-items-start mb-4 mb-lg-0 undefined">
                <a href="https://demos.creative-tim.com/astro-ecommerce/landing/#">
                  <div
                    className="full-background"
                    style={{
                      backgroundImage: `url(${require("./images/category3.jpg")})`,
                      backgroundSize: "cover",
                    }}
                  ></div>
                </a>
                <div className="card-body text-center w-100 pt-8">
                  ...
                  <div className="d-block mt-10">
                    <a href="https://demos.creative-tim.com/astro-ecommerce/landing/#">
                      <p className="text-white font-weight-bold mb-1">Summer</p>
                      <h4 className="text-white font-weight-bolder">
                        Festival
                      </h4>
                    </a>
              ...
              <div className="card card-background align-items-start mb-4 mb-lg-0 undefined">
                <a href="https://demos.creative-tim.com/astro-ecommerce/landing/#">
                  <div
                    className="full-background"
                    style={{
                      backgroundImage: `url(${require("./images/category4.jpg")})`,
                      backgroundSize: "cover",
                    }}
                  ></div>
                </a>
                <div className="card-body text-center w-100 pt-8">
                  ...
                  <div className="d-block mt-10">
                    <a href="https://demos.creative-tim.com/astro-ecommerce/landing/#">
                      <p className="text-white font-weight-bold mb-1">Sale</p>
                      <h4 className="text-white font-weight-bolder">
                        Showroom
                      </h4>
                    </a>
                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <div className="d-flex mb-4">
                      ...
                      <p>
                        Oil is highly versatile and used in the production of a
                        wide range of products. It serves as a raw material for
