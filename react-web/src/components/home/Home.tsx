...
import {useGetHighlightedCategoriesQuery} from "../../state/apiSlice";
...
const Home: FC = () => {
    ...
    if (isLoading) {
        ...
        const sortedList: List<Category> = List(sortedCategories);
        content = <CategoryList categories={sortedList}/>;
                    ...
                    <nav
                        ...
                        <div className="container px-1">
                            <a
                                ...
                                href="https://localhost:3030/astro"
                            >
                                UrbanThread
                            </a>
                            <button
