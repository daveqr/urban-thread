...
export function mapToDomainCategories(categoryEntities: CategoryEntity[]): Category[] {
...
export function mapEntityToProduct(productEntity: ProductEntity): Product {
    const categories: Category[] = mapToDomainCategories(productEntity.categories);
...
export function mapToDomainHighlightedCategories(categories: {
    position: any;
